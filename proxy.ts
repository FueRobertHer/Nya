...
// and the ops routes, export and rotate-master (OPS_SECRET, and off entirely
...
export const config = {
  matcher: [
    '/((?!api/login$|api/snapshot$|api/ingest/balance$|api/ops/export$|api/ops/rotate-master$|login$|_next/static/|_next/image/|favicon.ico$|icon.svg$|apple-icon.png$|manifest.json$|icons/|service-worker.js$).*)',
  ],
};
